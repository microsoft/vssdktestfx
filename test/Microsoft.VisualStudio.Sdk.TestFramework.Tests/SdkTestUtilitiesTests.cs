...
public class SdkTestUtilitiesTests : LoggingTestBase
{
    ...
    public async Task PromotedPackagesAvailable()
    {
        ...
        Assert.NotNull(await package.GetServiceAsync<SomePackage.SVsPromotedService, object>(TestContext.Current.CancellationToken));
        Assert.NotNull(await AsyncServiceProvider.GlobalProvider.GetServiceAsync<SomePackage.SVsPromotedService, object>(TestContext.Current.CancellationToken));
    }
    ...
    public async Task ServicesCached()
    {
        ...
        object serviceOne = await package.GetServiceAsync<SomePackage.SVsNonPromotedService, object>(TestContext.Current.CancellationToken);
        object serviceTwo = await package.GetServiceAsync<SomePackage.SVsNonPromotedService, object>(TestContext.Current.CancellationToken);
